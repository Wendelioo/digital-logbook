    ...
    try {
      ...
      if (formData.role === 'working_student' || formData.role === 'student') {
        if (!formData.studentId) {
          showNotification('error', `Student ID is required for ${formData.role === 'student' ? 'Students' : 'Student Staff'}`);
          return;
        }
      ...
      if ((formData.role === 'student' || formData.role === 'working_student') && !formData.departmentCode) {
        showNotification('error', 'Department is required for students and student staff');
        return;
      }
      ...
      if (editingUser) {
        ...
        const roleMessages = {
          ...
          'working_student': 'Student staff added successfully!',
