...
function DashboardOverview() {
  ...
  const [stats, setStats] = useState<DashboardStats>({
    ...
    today_new_users: 0,
    issue_reports_today: 0,
    no_issue_reports_today: 0,
    pending_feedback: 0,
  ...
  useEffect(() => {
    const loadStats = async () => {
      try {
        ...
        setStats({
          ...data,
          issue_reports_today: (data as unknown as { issue_reports_today?: number }).issue_reports_today ?? 0,
          no_issue_reports_today: (data as unknown as { no_issue_reports_today?: number }).no_issue_reports_today ?? 0,
          resolved_reports_today: (data as unknown as { resolved_reports_today?: number }).resolved_reports_today ?? 0,
        });
        setError('');
  ...
  const issueFeedbackCount = stats.issue_reports_today;
  const nonIssueFeedbackCount = stats.no_issue_reports_today;
            ...
            <CardBody>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <InfoCard
                  ...
                  value={currentLogin?.pc_number || (currentLogin ? 'Unconfigured PC' : 'Not Logged In')}
        ...
        <div className="lg:border-l lg:border-gray-300 lg:pl-6">
          <Card className="h-fit">
            ...
            <CardBody>
              ...
              >
                <div className="flex flex-col items-start gap-2">
                  <span className="text-sm font-semibold text-gray-800">
                    {nonIssueFeedbackCount > 0 ? 'No Issues (All Working)' : 'No Issues'}
                  </span>
                  <span
              ...
              <div
                className={`p-3 rounded-lg border ${
                  stats.resolved_reports_today > 0
              ...
              >
                <div className="flex flex-col items-start gap-2">
                  ...
                  <span
                    className={`text-2xl font-bold ${
                      stats.resolved_reports_today > 0 ? 'text-primary-700' : 'text-gray-500'
                    }`}
                  >
                    ...
                    <tr className="hover:bg-gray-50/50">
                      <td className="px-3 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-medium text-gray-800">Student Staff Online</span>
                        </div>
                      </td>
                      <td className="px-3 py-3 text-right">
