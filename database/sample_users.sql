...
('BSED', 'Bachelor of Secondary Education', 1),
('BSEE', 'Bachelor of Science in Electrical Engineering', 1);
/* ================================
   ADMIN ACCOUNTS
...
/* ================================
   SAMPLE SUBJECTS AND CLASSES (for teachers)
   Five active classes: one per sample teacher (2000001–2000005).
   Join codes are fixed for local testing; change if they collide with your data.
================================ */
INSERT INTO subjects (subject_code, description) VALUES
('IT101', 'Introduction to Information Technology'),
('CS101', 'Computer Programming 1'),
('IT201', 'Database Systems'),
('BA101', 'Business Communication'),
('ED101', 'Principles of Teaching')
ON DUPLICATE KEY UPDATE
    description = VALUES(description),
    updated_at = NOW();

INSERT INTO classes (subject_code, teacher_id, edp_code, join_code, descriptive_title, section, schedule, room, semester, school_year, is_active, created_by_user_id)
SELECT 'IT101', t.id, 'EDP-IT101-311A', 'JOIN-SMP-IT101-01', 'Introduction to Information Technology', '311A', 'MWF 08:00-09:30', 'LAB-101', '1st', '2025-2026', 1, t.id
FROM teachers t WHERE t.teacher_id = '2000001' LIMIT 1;

INSERT INTO classes (subject_code, teacher_id, edp_code, join_code, descriptive_title, section, schedule, room, semester, school_year, is_active, created_by_user_id)
SELECT 'CS101', t.id, 'EDP-CS101-210B', 'JOIN-SMP-CS101-01', 'Computer Programming 1', '210B', 'TTH 10:00-11:30', 'LAB-205', '1st', '2025-2026', 1, t.id
FROM teachers t WHERE t.teacher_id = '2000002' LIMIT 1;

INSERT INTO classes (subject_code, teacher_id, edp_code, join_code, descriptive_title, section, schedule, room, semester, school_year, is_active, created_by_user_id)
SELECT 'IT201', t.id, 'EDP-IT201-312C', 'JOIN-SMP-IT201-01', 'Database Systems', '312C', 'MWF 13:00-14:30', 'LAB-102', '2nd', '2025-2026', 1, t.id
FROM teachers t WHERE t.teacher_id = '2000003' LIMIT 1;

INSERT INTO classes (subject_code, teacher_id, edp_code, join_code, descriptive_title, section, schedule, room, semester, school_year, is_active, created_by_user_id)
SELECT 'BA101', t.id, 'EDP-BA101-101D', 'JOIN-SMP-BA101-01', 'Business Communication', '101D', 'TTH 08:00-09:30', 'ROOM-301', '1st', '2025-2026', 1, t.id
FROM teachers t WHERE t.teacher_id = '2000004' LIMIT 1;

INSERT INTO classes (subject_code, teacher_id, edp_code, join_code, descriptive_title, section, schedule, room, semester, school_year, is_active, created_by_user_id)
SELECT 'ED101', t.id, 'EDP-ED101-201E', 'JOIN-SMP-ED101-01', 'Principles of Teaching', '201E', 'MWF 15:00-16:30', 'ROOM-210', '1st', '2025-2026', 1, t.id
FROM teachers t WHERE t.teacher_id = '2000005' LIMIT 1;
